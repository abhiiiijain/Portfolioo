// export const Work = [
        export const Project = [
                ...
                },
                {
                    id:2,
                    name:"Shop-O",
                    description:"An E-commerce website. Attached with an existing trainer's Mango DB Backend. Well Designed using Bootstrap, Material UI and React JS.",
                    tags:["react","mongodb"],
                ...
                },
                {
                    id:3,
                    name:"WoodCase",
                    description:"A commercial website from where you can buy household material made from wood.",
